      ...
      <div>
        <svg className="" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeWidth="2"
            strokeLinecap="round"
            className="stroke-yellow-500 md:stroke-white"
          />
          <path d="M27.5 5L15 17.5125L11.25 13.7625" className="stroke-yellow-500 md:stroke-white" strokeWidth="2" />
        </svg>
      </div>
      <div>
        <h1 className="text-xl md:text-2xl font-bold"> {props.title} </h1>
        <p className="mt-4 md:mt-6 text-base text-zinc-200 max-w-md">{props.text} </p>
      </div>
    </div>
  );
};
