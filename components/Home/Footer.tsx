...
export const Footer = () => {
  return (
    <div className="w-full bg-custom pt-12 px-6 md:px-20 pb-14">
      <div className="mx-auto max-w-screen-1/2xl">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 bg-yellow-500 pt-10 px-12 pb-28 rounded-3xl">
            <label className="text-black text-xl font-semibold max-w-lg">
              Sign Up to Receive Product Updates and More
            </label>
            <div className="flex border-b border-black mt-4">
              <input
                className="bg-transparent text-black placeholder-black w-full"
                type="email"
          ...
          <div className="flex flex-col md:flex-row space-y-10 md:space-y-0 mx-auto justify-center pt-16 md:justify-between md:ml-24 w-1/2">
            <div className="w-56 text-center">
              <h4 className="text-lg text-white">Office</h4>
              <p className="mt-4">545, Street 11, Block F California, U.S.A</p>
            </div>
            <div className=" w-56 md:w-1/2  text-center">
              <h4 className="text-white">Contact</h4>
              <p className="mt-4">+92 302 300 3215</p>
              <p className="mt-4">ouraddress@email.com</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col md:flex-row items-center md:justify-between mt-14 space-y-8">
          <div className="hidden md:block">
            <p>2022. All Rights Reserved</p>
          </div>
          <div>
            <ul className="flex flex-col md:flex-row text-center space-y-2 md:space-y-0 md:space-x-4  text-white">
              <span className="cursor-pointer">{'Terms & Conditons'}</span>
